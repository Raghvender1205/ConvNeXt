...
from tensorflow.keras.layers import Conv2D, Dense, DepthwiseConv2D, GlobalAveragePooling2D, Layer, LayerNormalization
...
class Block(Layer):
    ...
    def __init__(self, dim, drop_path=0., layer_scale_init_value=1e-6, prefix=''):
        super().__init__()
        self.dwconv = DepthwiseConv2D(kernel_size=7, paddding='same') # DepthwiseConv2D
